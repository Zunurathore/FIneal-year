...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <a target="_blank" href="{{URL::to('https://www.chartjs.org/docs/latest/')}}">Chart.js documentation</a>
                                .
                            </div>
                        </div>
                        <div class="card mb-4">
        ...
        <script src="{{URL::to('demo/chart-area-demo.js')}}"></script>
        <script src="{{URL::to('demo/chart-bar-demo.js')}}"></script>
        <script src="{{URL::to('demo/chart-pie-demo.js')}}"></script>
    </body>
</html>
