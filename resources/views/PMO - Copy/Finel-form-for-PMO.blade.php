            ...
            <main>
              <section class="section mt-3">
                <div class="container d-flex justify-content-center">
                  <div class="row  w-75">
                    <h2 class="d-flex justify-content-center mb-5">Finel Evaluator Form</h2>
                    <div class="col-lg-12">
                      <form>
                        <div class="mb-4 border rounded">
                          <div class="m-3">
                              ...
                              <div class="form-outline mb-4">
                                <span class="d-flex justify-content-center mb-4 fs-5">Finel Evaluation Form</span>
                                <div class="row ">
                                  <div class="col">
                              ...
                              <div class="form-outline mb-4">
                                ...
                                <div class="row mb-4 mt-2">
                                  ...
                                  <div class="row mb-4 mt-3">
                                      <div class="col">
                                        <div class="form-outline">
                                          <label class="form-label" for="form6Example30">Ch.1 <br> 5 Marks</label>
                                          <input type="email" id="form6Example30" class="form-control" placeholder=""/>
                                        </div>
                                      </div>
                                      <div class="col">
                                        <div class="form-outline">
                                          <label class="form-label" for="form6Example30">Ch.2 <br> 5 Marks</label>
                                          <input type="email" id="form6Example30" class="form-control" placeholder=""/>
                                        </div>
                                      </div>
                                      <div class="col">
                                        <div class="form-outline">
                                          <label class="form-label" for="form6Example30">Ch.3 <br> 10 Marks</label>
                                          <input type="email" id="form6Example30" class="form-control" placeholder=""/>
                                        </div>
                                      </div>
                                      <div class="col">
                                        <div class="form-outline">
                                          <label class="form-label" for="form6Example30">Doc<br> 5 Marks</label>
                                          <input type="email" id="form6Example30" class="form-control" placeholder=""/>
                                        </div>
                                      </div>
                                      <div class="col">
                                        <div class="form-outline">
                                          <label class="form-label" for="form6Example30">Total <br> 25 Marks</label>
                                          <input type="email" id="form6Example30" class="form-control" placeholder=""/>
                                        </div>
                                      </div>
                                  </div>
