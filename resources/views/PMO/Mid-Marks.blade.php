    ...
    <main>
      <section class="section mt-3">
        <div class="container d-flex justify-content-center">
          <div class="row  w-75">
            <h2 class="d-flex justify-content-center mb-5" style="color: #4040a2;">Mid Marks</h2>
            <div class="col-lg-12">
              <form>
                 <div class="mb-4 border rounded">
                    <div class="m-3">
                      ...
                      <div class="row mb-4">
                        <div class="col">
                          <div class="form-outline">
                            ...
                            <input type="text" id="form6Example1" class="form-control" placeholder="Marks out of 8" required/>
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-outline">
                            ...
                            <input type="text" id="form6Example2" class="form-control" placeholder="Marks out of 8" required/>
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-outline">
                      ...
                      <div class="form-outline mb-4">
                            <label class="form-label" for="form6Example3">Front End Marks</label>
                            <input type="text" id="form6Example3" class="form-control" placeholder="Marks out of 16" required />
                      </div>
                  </div>
                  </div>
                <!-- <div class="mb-4 border rounded">
