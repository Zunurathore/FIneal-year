      ...
      <section class="section mt-3">
        <div class="container d-flex justify-content-center">
          <div class="row  w-75">
            ...
            <div class="col-lg-12">
              <form action="{{URL::to('PMO/updatepmosave')}}" method="POST">
                @csrf
                      ...
                      <div class="row mb-4">
                        <div class="col">
                          <div class="form-outline">
                            ...
                            <input type="text" id="form6Example1" class="form-control" name="name" placeholder="PMO" value="{{$pmo->name}}" required />
                            <input type="hidden" id="form6Example1" class="form-control" name="id" value="{{$pmo->id}}" />
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-outline">
                        ...
                        <div class="row mb-4 mt-2">
                          ...
                          <div class="col">
                            <div class="form-outline">
                              ...
                              <input type="tel" id="form6Example20" class="form-control" placeholder="ex# 03001234567" pattern="[0-9]{4}[0-9]{7}" name="pnumber" value="{{$pmo->pnumber}}" required/>
                            </div>
                          </div>
                          <!-- <div class="col">
                            <div class="form-outline">
                      ...
                      <div class="form-outline mb-4">
                        ...
                        <div class="row mb-4 mt-2">
                          ...
                          <div class="col">
                            <div class="form-outline">
                              <label class="form-label" for="form6Example30">Email</label>
                              <input type="email" id="form6Example30" class="form-control" placeholder="Email" name="email" value="{{$pmo->email}}" required/>
                            </div>
                          </div>
                          <div class="col">
                            <div class="form-outline">
                              <label class="form-label" for="form6Example40">Password</label>
                              <input type="text" id="form6Example40" class="form-control" placeholder="********" name="password" value="{{$pmo->password}}" required/>
                            </div>
                          </div>
                        </div>
                      </div>
