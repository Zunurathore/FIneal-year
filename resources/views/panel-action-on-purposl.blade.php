                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="purposel-action-for-panel.html" class="btn btn-primary btn-sm  ms-3">View</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="form-outline mb-4 border rounded">
                                <div class="m-3">
                                  <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Resaon for reject/list moduls whant to add</label>
